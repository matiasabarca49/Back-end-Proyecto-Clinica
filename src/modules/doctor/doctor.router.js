...
import { getDoctors, createDoctor, deleteDoctor, updateDoctor, getDoctorById, getSchedules} from './doctor.controller.js';
import { authRoles, authToken } from '../../middlewares/auth.middlewares.js';
import { validateDoctorData, validateUpdateDoctor } from './doctor.validation.js';
